...
/**
 * Interface which defines the configurable properties for SmartphoneSensorAsset.
 */
@OCD (description = ConfigurationConstants.PARTIAL_OBJECT_CLASS_DEFINITION)
public interface SmartphoneSensorAssetAttributes extends AssetAttributes
{
    //No asset attributes are available.
}