...
public class EventHandlerSyncer implements EventHandler
{
    ...
    public EventHandlerSyncer(final BundleContext context, final String topic)
    {
        this(context, new String[] { topic }, null, null, null);
    }
    
    public EventHandlerSyncer(final BundleContext context, final String topic, final ExpectedEvent expected)
    {
        this(context, new String[] {topic}, null, null, expected);
    }
    
    public EventHandlerSyncer(final BundleContext context, final String[] topics)
    {
        this(context, topics, null, null, null);
    }
    
    public EventHandlerSyncer(final BundleContext context, final String topic, final String filter)
    {
        this(context, new String[] { topic }, filter, null, null);
    }
    
    public EventHandlerSyncer(final BundleContext context, final String topic, final String filter, 
            final ExpectedEvent expected)
    {
        this(context, new String[] { topic }, filter, null, expected);
    }
    
    public EventHandlerSyncer(final BundleContext context, final String[] topics, final String filter)
    {
        this(context, topics, filter, null, null);
    }
    
    public EventHandlerSyncer(final BundleContext context, final String topic, final String filter, 
            final EventHandler handler)
    {
        this(context, new String[] { topic }, filter, handler, null);
    }
    
    public EventHandlerSyncer(final BundleContext context, final String topic, final String filter, 
            final EventHandler handler, final ExpectedEvent expected)
    {
        this(context, new String[] { topic }, filter, handler, expected);
    }
    
    public EventHandlerSyncer(final BundleContext context, final String[] topics, final String filter, 
            final EventHandler handler)
    {
       this(context, topics, filter, handler, null);
    }
            ...
            final EventHandler handler, final ExpectedEvent expectedEvent)
    {
        ...
        m_Registration = context.registerService(EventHandler.class, this, d);
     ...
     */
    public List<Event> waitForEvent(int timeoutSec, int times, int extraTimeout) throws InterruptedException
    {
        return waitForEvent(timeoutSec, true, -times, extraTimeout);
    }
     ...
     *      how long in seconds to wait
     */
    public Event waitForEvent(int timeoutSec)
    {
        return waitForEvent(timeoutSec, true, 1, 0).get(0);
    }
     ...
     */
    public List<Event> waitForEvent(int timeoutSec, boolean doAssert, int times, int extraTimeout)
    {
        ...
        try
        {
            if (times > 0)
            {
                final boolean acquired = m_WaitSem.tryAcquire(times, timeoutSec, TimeUnit.SECONDS);
                if (doAssert)
                {
