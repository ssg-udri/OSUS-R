...
/**
 * Test the physical link implementation of the 
 * {@link mil.dod.th.ose.core.factory.api.data.BaseFactoryObjectDataManager}.
 * @author callen
 *
 */
public class TestPhysicalLinkFactoryObjectDataManagerImpl
{
    private PhysicalLinkFactoryObjectDataManagerImpl m_SUT;
    private PersistentDataStore m_PersistentDataStore;
    
    @Before
    public void setUp()
    {
        m_SUT = new PhysicalLinkFactoryObjectDataManagerImpl();
    ...
    /**
     * Verify factory object service type is physical link.
     */
    @Test
    public void testGetServiceObjectType()
    {
        assertThat(m_SUT.getServiceObjectType().getName(), is(PhysicalLink.class.getName()));
    }
}
