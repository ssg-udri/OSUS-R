...
/**
 * Defines the metadata for the properties available to the {@link example.asset.lexicon.ExampleObservationsAsset}.
 * 
 * @author cweisenborn
 */
@OCD (description = ConfigurationConstants.PARTIAL_OBJECT_CLASS_DEFINITION)
public interface ExampleObservationsAssetAttributes extends AssetAttributes
{
