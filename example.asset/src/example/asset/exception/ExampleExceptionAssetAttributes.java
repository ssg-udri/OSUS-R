...
/**
 * Defines the metadata for the properties available to the {@link example.asset.exception.ExampleExceptionAsset}.
 * 
 * @author cweisenborn
 */
@OCD (description = ConfigurationConstants.PARTIAL_OBJECT_CLASS_DEFINITION)
public interface ExampleExceptionAssetAttributes extends AssetAttributes
{
