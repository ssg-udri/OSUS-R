...
@SuppressStaticInitializationFor("mil.dod.th.ose.archiver.vlc.VlcArchiver")
public class TestVlcEventListener
{
    @Mock private VlcArchiver m_Archiver;
    ...
    public void setUp() throws Exception
    {
        ...
        m_SUT = new VlcEventListener(m_Archiver, m_ListenerId);
    }
    ...
    public void testPlaying()
    {
        ...
        verify(m_Archiver).playingEvent(m_ListenerId);
    }
    ...
    public void testError()
    {
        ...
        verify(m_Archiver).errorEvent(m_ListenerId);
    }
    ...
    public void testStopped()
    {
        ...
        verify(m_Archiver).stoppedEvent(m_ListenerId);
    }
