...
public class TestAssetDirectoryMessageGeneratorImpl
{
    private AssetDirectoryMessageGeneratorImpl m_SUT;

    @Before
    public void setUp() throws Exception
    {
        m_SUT = new AssetDirectoryMessageGeneratorImpl();
    }

    @Test
    public void testCreateGetAssetsRequest() throws IOException
    {
        ...
        MessageBuilder builder = m_SUT.createGetAssetsRequest();
