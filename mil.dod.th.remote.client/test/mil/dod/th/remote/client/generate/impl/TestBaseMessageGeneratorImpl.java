...
public class TestBaseMessageGeneratorImpl
{
    private BaseMessageGeneratorImpl m_SUT;

    @Before
    public void setUp() throws Exception
    {
        m_SUT = new BaseMessageGeneratorImpl();
    }

    @Test
    public void testCreateGetControllerInfoRequest() throws IOException
    {
        ...
        MessageBuilder builder = m_SUT.createGetControllerInfoRequest();
