...
/**
 * Represents a remote message for the {@link Namespace#DataStreamService} namespace.
 * 
 * @author jmiller
 *
 */
public class DataStreamServiceMessage implements RemoteMessage<DataStreamServiceNamespace>
{
    private final TerraHarvestMessage m_RawMessage;
    private final TerraHarvestPayload m_PayloadMessage;
    private final DataStreamServiceNamespace m_NamespaceMessage;
    private final Message m_DataMessage;

    /**
     * Creates a new remote message for the {@link Namespace#DataStreamService} namespace.
     * 
     * @param rawMessage
     ...
     */
    public DataStreamServiceMessage(final TerraHarvestMessage rawMessage, final TerraHarvestPayload payloadMessage,
            final DataStreamServiceNamespace namespaceMessage, final Message dataMessage)
    {
    ...
    @Override
    public DataStreamServiceNamespace getNamespaceMessage()
    {
