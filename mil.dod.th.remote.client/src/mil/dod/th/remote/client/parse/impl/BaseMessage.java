...
/**
 * Represents a remote message for the {@link Namespace#Base} namespace.
 * 
 * @author dlandoll
 */
public class BaseMessage implements RemoteMessage<BaseNamespace>
{
    private final TerraHarvestMessage m_RawMessage;
    private final TerraHarvestPayload m_PayloadMessage;
    private final BaseNamespace m_NamespaceMessage;
    private final Message m_DataMessage;

    /**
     * Creates a new remote message for the {@link Namespace#Base} namespace.
     * 
     * @param rawMessage
     ...
     */
    public BaseMessage(final TerraHarvestMessage rawMessage, final TerraHarvestPayload payloadMessage,
        final BaseNamespace namespaceMessage, final Message dataMessage)
    {
    ...
    @Override
    public BaseNamespace getNamespaceMessage()
    {
    ...
    {
        return m_NamespaceMessage.getType() == BaseMessageType.GenericErrorResponse;
    }
