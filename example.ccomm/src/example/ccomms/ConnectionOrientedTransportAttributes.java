...
/**
 * Defines the metadata for the properties available to the {@link example.ccomms.ConnectionOrientedTransport}.
 *
 * @author jlatham
 */
@OCD (description = ConfigurationConstants.PARTIAL_OBJECT_CLASS_DEFINITION)
public interface ConnectionOrientedTransportAttributes extends TransportLayerAttributes
{
