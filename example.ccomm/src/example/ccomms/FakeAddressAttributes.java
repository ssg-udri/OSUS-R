...
/**
 * Defines the metadata for the properties available to the {@link example.ccomms.FakeAddress}.
 * 
 * @author thanuscin
 */
@OCD (description = ConfigurationConstants.PARTIAL_OBJECT_CLASS_DEFINITION)
public interface FakeAddressAttributes extends AddressAttributes
{
    /**
     * Fake property.
     * 
