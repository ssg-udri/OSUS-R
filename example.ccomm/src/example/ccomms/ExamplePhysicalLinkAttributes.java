...
/**
 * Defines the metadata for the properties available to the {@link example.ccomms.ExamplePhysicalLink}.
 * 
 * @author cweisenborn
 */
@OCD (description = ConfigurationConstants.PARTIAL_OBJECT_CLASS_DEFINITION)
public interface ExamplePhysicalLinkAttributes extends PhysicalLinkAttributes
{
