...
/**
 * Defines the metadata for the properties available to the {@link example.ccomms.ExampleAddress}.
 * 
 * @author cweisenborn
 */
@OCD (description = ConfigurationConstants.PARTIAL_OBJECT_CLASS_DEFINITION)
public interface ExampleAddressAttributes extends AddressAttributes
{
    /**
     * Example property.
     * 
