...
public class TestAddCommsDlg
{
    ...
    /**
     * Assuming default controller is the active controller, assuming example platform and example good plugin
     * bundles are in the controller. Verify the example physical link, example link layer,
     * echo transport, and direct transport layers show up in the layer type 
     * lists.
     */
    @Test
    public void testCreateStackDialog() throws InterruptedException
    {
        ...
        WebElement layer = CommsAddDialogHelper.
                layerSelectHelper(m_Driver, "Link Layer", "example.ccomms.ExampleLinkLayer");
        ...
        wait.until(ExpectedConditions.not(ExpectedConditions.
                textToBePresentInElementLocated(By.cssSelector("div[id*='llDescription']"),
                        "Select a Layer to see Description.")));
        ...
        //wait for text to change
        wait.until(ExpectedConditions.not(ExpectedConditions.
                textToBePresentInElementLocated(By.cssSelector("div[id*='transDesc']"), 
                        "Select a Layer to see Description.")));
        ...
        wait.until(ExpectedConditions.visibilityOf(
            m_Driver.findElement(By.cssSelector("div[id$='physicalTypesData']"))));
        
        //assert that known physical types exist and that specs contain proper info
        layer = CommsAddDialogHelper.
                layerSelectHelper(m_Driver, "Physical Link", PhysicalLinkTypeEnum.I_2_C.toString());
        assertThat(layer, is(notNullValue()));
        ...
        layer = CommsAddDialogHelper.
                layerSelectHelper(m_Driver, "Physical Link", PhysicalLinkTypeEnum.SERIAL_PORT.toString());
        assertThat(layer, is(notNullValue()));
    ...
    /**
     * Assuming default controller is the active controller, assuming example platform and example good plugin
     * bundles are in the controller. Verify stack is created and layers are displayed on GUI. 
     */
    @Test
    public void testCreateStack() throws InterruptedException, ExecutionException, TimeoutException
    {
        ...
        CommsGeneralHelper.createStack(m_Driver, physName, "duck", 
                "example.ccomms.ExampleLinkLayer", "goose", "example.ccomms.DirectTransport");
        ...
        List<WebElement> commsTableElements = table.findElements(By.
                cssSelector("tbody>tr+tr>td+td>table>tbody>tr"));
    ...
    public void testCreateStackValidationFail() throws InterruptedException
    {
        ...
        WebElement layer = CommsAddDialogHelper.
                layerSelectHelper(m_Driver, "Transport Type", "example.ccomms.DirectTransport");
        assertThat(layer, is(notNullValue()));
        layer.click();
        wait.until(ExpectedConditions.textToBePresentInElementValue(By.
                cssSelector("input[name$='transportData_selection']"), "example.ccomms.DirectTransport"));
        ...
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.
                cssSelector("button[id*='closeValidationButton']")));        
        WebElement closeButton = m_Driver.findElement(By.cssSelector("button[id*='closeValidationButton']"));
        closeButton.click();
        
        //grab all validation errors
        List<WebElement> validationErrors = m_Driver.findElements(By.
                cssSelector("span[class='ui-message-error-detail']"));
        ...
        assertThat(dialogErrors, hasItems("Type must be selected.", 
                "Enter a name for the new link layer.",
                "Physical link must be selected.",
                "Enter a name for the new transport layer."));
    ...
    /**
     * Verify canceling confirm dialog will go back to add comms dialog.
     * Verify canceling will not create stack. 
     */
    @Test
    ...
    {                
        ...
        layer.click();
        wait.until(ExpectedConditions.textToBePresentInElementValue(By.
                cssSelector("input[name$='linkData_selection']"), "example.ccomms.ExampleLinkLayer"));
        ...
        layer.click();
        wait.until(ExpectedConditions.textToBePresentInElementValue(By.
                cssSelector("input[name$='physicalData_selection']"), physName));
        ...
        WebElement addStack = wait.until(ExpectedConditions.visibilityOfElementLocated(By.
                cssSelector("div[id$='addAccordion']")));   
    ...
    /**
     * Verify types of usable layers are successfully refreshed after
     * removal of a bundle.  
     */
    @Test
    public void testRefreshTypes() throws InterruptedException
    {
        ...
        wait.until(ExpectedConditions.presenceOfElementLocated(By.
                cssSelector("tbody[id$='transportData_data']>tr>td>div")));
        wait.until(ExpectedConditions.presenceOfElementLocated(By.
                cssSelector("tbody[id$='linkData_data']>tr>td>div")));
