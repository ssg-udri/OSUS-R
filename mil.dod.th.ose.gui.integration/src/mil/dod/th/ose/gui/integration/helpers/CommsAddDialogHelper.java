...
/**
 * Comms helper to assist with add comms dialog functions with assumptions that an active controller 
 * with the example platform bundle.
 * @author bachmakm
 *
 */
...
{    
    ...
    /**
     * Method that finds and return the WebElement that represents the specified comms layer type image on 
     * the add comms stack dialog.
     * This method returns null if the specified comms layer image cannot be found.
     * @param driver
     *  the web driver to use.
     * @param layerTypeName
     *  the name of the layer type to be retrieved.
     * @return
     *  the element that represents the specified layer type image or <code>null</code> if it cannot be found.
     */
    ...
    public static String getTopPhysicalLinkName(final WebDriver driver)
    {
        ...
        fwait.until(ExpectedConditions.presenceOfElementLocated(By.
                cssSelector("tbody[id$='physicalData_data']>tr>td")));
        try
        {
            WebElement topPhysElement =  driver.findElement(By.
                cssSelector("tbody[id$='physicalData_data']>tr>td:nth-child(2)"));
    ...
    {        
        ...
        WebElement forceAddCheckBox = driver.findElement(By.
                cssSelector("input[id$='addAccordion:forceAddCheckBox_input']"));
        ...
        List<WebElement> physicalConfirmInfo = driver.findElements(By.
                cssSelector("tr[class='ui-widget-content']>td")); 
    ...
    public static void putInForceAddPhysicalLinkMode(final WebDriver driver) throws InterruptedException
    {
        ...
        Wait<WebDriver> linkTabWait = new FluentWait<WebDriver>(driver).withTimeout(30, TimeUnit.SECONDS).
