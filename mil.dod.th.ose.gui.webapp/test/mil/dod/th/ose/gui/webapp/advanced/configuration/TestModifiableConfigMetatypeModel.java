...
/**
 * Test class for the {@link ModifiableConfigMetatypeModel} class.
 * 
 * @author cweisenborn
 */
public class TestModifiableConfigMetatypeModel
{
    private ModifiableConfigMetatypeModel m_SUT;
    
    @Before
    public void setup()
    {
        m_SUT = new ModifiableConfigMetatypeModel("some pid");
    }
    ...
    {
        ModifiablePropertyModel property = ModelFactory.createPropModel("key", "value");
